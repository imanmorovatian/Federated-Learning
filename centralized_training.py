# -*- coding: utf-8 -*-
"""Centralized Training.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1T3ISysSWiwT1aEazZHyTJtdaOachjfxK
"""
...
ATTEMPT = 1 # always increament this variable by one and set the new value for that
...
optimizer = optim.SGD(net.parameters(), lr=LEARNING_RATE, momentum=MOMENTUM, weight_decay=WEIGHT_DECAY, nesterov=NESTEROV)
